...
def save_to_csv(binary_file, csv_file):
    with open(csv_file, "w", newline="") as csvfile:
        ...
        writer.writerow([
            ...
            "size", "finalChargesTot", "totalInducedCharge", "ElecThr", "ElecThrReachedTime", "ElecMax", "InducedChargeThr",
        ...
        while reader.nextResult():
            writer.writerow([
                ...
                reader.result.totalInducedCharge,
